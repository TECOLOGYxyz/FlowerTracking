...
Different phenological factors, such as onset, peak, and end of flowering may respond differently to climate change [kilder fra første manuskript] and estimation of the degree of mismatch between species may thus be sensitive to the choice of metric [@inouye2019]. Efficient and precise methods for deriving full seasonal distributions of phenology at the level of individuals is much needed but usually prevented for logistical reasons.
