...
Manually annotating a subset of the objects in the image series could help derive a good set of parameters.

When deploying the tracking algorithm on naive data that has not been manually tracked, it is not possible to 
