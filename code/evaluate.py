...
## write false positives to csv
false_positives_df.to_csv(r"U:\BITCue\Projekter\NorwayAnnotations\Experiments\2020_06_30_DetectionPhenology\Rmd\ModelQ_Results\DT_GT/FalsePositivesInSampledOld.csv", index = False) #temp
##
