...
sims = pd.read_csv(r"U:\BITCue\Projekter\TrackingFlowers\data\simulation\maxdistExample.csv")
...
# We are ready to run tracking on the file
t = tracker(4, 500, 5, r"U:\BITCue\Projekter\TrackingFlowers/codeTest_DELETE.csv", sims, True) # Instantiate the class instance and pass in the threshold for max_disappeared and the list of frames.
t.track() # Run the tracking algorithm.
