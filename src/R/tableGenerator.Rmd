...
seriesOverview = read.csv2("U:/BITCue/Projekter/TrackingFlowers/data/annotations/seriesOverview.csv", header = T)
colnames(seriesOverview) = c('Image series','Number of images', 'Number of flowers')
seriesOverview
...
seriesOverview  %>% 
  ...
  cols_align(
    align = "left") %>% 
    gtsave("U:/BITCue/Projekter/TrackingFlowers/src/R/seriesOverview.png", expand = 10)
